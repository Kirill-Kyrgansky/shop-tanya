function productParse() {
    let product = {
        name: localStorage.getItem('name'),
        description: localStorage.getItem('description'),
        composition: localStorage.getItem('composition'),
        img: localStorage.getItem('img'),
        price: localStorage.getItem('price'),
        volume: localStorage.getItem('volume'),
        type: localStorage.getItem('type')
    }
    const productListContainer = document.getElementById('app');
    ...
    productListContainer.innerHTML = `
        ...
        <div class="product-description">
            ...
            <div class="p-16-30 border radius mb-20">
                <p class="paragraph mb-20">Описание: ${product.description}</p>
                <p class="paragraph">Состав: ${product.composition}</p>
            </div>
            <div class="flex space-between ">
                <button class="animate-button flex align-center dropdown link mr-20">
                ...
                <div class="border radius flex align-center title-4 p-16-30">
                    <p class="mr-20">${product.price}</p>
                    <p class="mr-20">|</p>
                    <p>${product.volume}</p>
                </div>    
            </div>
